...
import { AllCountries, Country } from "../../../assets/helpers/AllCountries";
import { AllStates, State } from "../../../assets/helpers/AllStates";
import { AllCities, City } from "../../../assets/helpers/AllCities";
...
const EditContact: FC = () => {
  ...
  return (
    <IonPage className={styles.edit_contact}>
      <IonHeader>
        <IonToolbar>
